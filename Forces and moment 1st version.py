...
graph_many_wave_length("pdstrip.out1.ok", 200, 2000, 0, 0, "real")
graph_many_speed("pdstrip.out1.ok", 0, 10, 42.79, 100, "real")
...
graph_file_for_one_wave("pdstrip.out1.ok",42.79,100.0,0,"real",True, True,"speed")
print(extreme_point)